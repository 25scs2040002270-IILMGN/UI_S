...
const Counter = ({ value, label }: { value: number; label: string }) => {
  ...
  return (
    <div className="flex flex-col items-center p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
      <span className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-300">
    ...
    >
      ...
      <section className="relative overflow-hidden pt-24 pb-32">
        <div className="absolute inset-0 z-0 flex items-center justify-center">
          <div className="absolute w-[800px] h-[800px] bg-blue-500/20 rounded-full blur-[120px] mix-blend-screen opacity-50 animate-blob"></div>
          <div className="absolute w-[600px] h-[600px] bg-purple-500/20 rounded-full blur-[100px] mix-blend-screen opacity-50 animate-blob animation-delay-2000"></div>
          <div className="absolute w-[700px] h-[700px] bg-cyan-500/20 rounded-full blur-[110px] mix-blend-screen opacity-50 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500">
              Rise to the Top.
            </span>
          </motion.h1>
          ...
          >
            ...
            <Link href="/quiz-arena/leaderboard">
              <Button size="lg" variant="outline" className="h-14 px-8 text-base font-semibold rounded-full border-white/10 hover:bg-white/5">
                View Leaderboard
              </Button>
            </Link>
          </motion.div>
      ...
      <section className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">An Instrument of Excellence</h2>
        ...
        >
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl bg-card border border-white/5 hover:border-white/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden"
            >
