  ...
  return (
    ...
    >
      <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-lg font-medium flex items-center gap-2">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {certificates.map((cert, idx) => (
          <motion.div
            ...
            className="group relative p-px rounded-2xl bg-gradient-to-br from-primary/20 to-accent/10 overflow-hidden"
          >
            {/* Inner frame */}
            <div className="bg-card border border-border h-full rounded-xl p-8 flex flex-col relative overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="relative z-10 flex-1">
                ...
                <h3 className="text-2xl font-serif font-bold text-foreground mb-2">{cert.title}</h3>
              ...
              <div className="mt-auto pt-6 border-t border-border flex justify-between items-center relative z-10">
                ...
                <Button
                  ...
                  className="border-blue-500/30 hover:bg-blue-500/10 text-blue-600 dark:text-blue-400"
                >
