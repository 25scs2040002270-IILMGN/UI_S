          ...
          return (
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className={`font-semibold ${isActive ? "text-cyan-400" : "text-white"}`}>{cat}</h3>
                <Calculator className={`w-5 h-5 ${isActive ? "text-cyan-400" : "text-muted-foreground"}`} />
              </div>
              ...
              <div className="h-2 bg-background rounded-full overflow-hidden">
                <div 
                  className={`h-full rounded-full transition-all duration-1000 ${isActive ? "bg-cyan-400" : "bg-muted-foreground"}`} 
        ...
        {filteredQuestions.length > 0 ? (
          filteredQuestions.map((q, idx) => (
            <motion.div
              ...
              key={q.id}
              className="p-6 rounded-2xl bg-card border border-white/10 flex flex-col justify-between"
            >
              <div className="mb-6">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-lg font-semibold text-white leading-tight">{q.title}</h3>
          ...
          <div className="col-span-2 p-12 text-center text-muted-foreground bg-card rounded-2xl border border-white/10">
