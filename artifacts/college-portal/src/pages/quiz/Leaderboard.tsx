      ...
      <div className="flex flex-col md:flex-row items-end justify-center gap-4 md:gap-8 mb-20 h-auto md:h-80 mt-12 px-4">
        ...
        >
          <div className="mb-4 text-center">
            ...
            <div className="font-bold text-lg text-foreground">{top3[1].name}</div>
            <div className="text-gray-500 dark:text-gray-400 font-semibold">{top3[1].totalPoints} pts</div>
          </div>
          <div className="w-full h-32 md:h-40 bg-gradient-to-t from-gray-500/20 to-gray-400/40 rounded-t-xl border border-gray-400/30 border-b-0 relative flex justify-center pt-4">
            <span className="text-4xl font-black text-gray-500 dark:text-gray-300">2</span>
          </div>
        </motion.div>
        ...
        >
          <div className="mb-4 text-center">
            ...
            <div className="font-bold text-xl text-foreground">{top3[0].name}</div>
          ...
          <div className="w-full h-40 md:h-56 bg-gradient-to-t from-yellow-600/20 to-yellow-500/40 rounded-t-xl border border-yellow-500/30 border-b-0 relative flex justify-center pt-4">
            <span className="text-5xl font-black text-yellow-600 dark:text-yellow-200">1</span>
          </div>
        </motion.div>
        ...
        >
          <div className="mb-4 text-center">
            ...
            <div className="font-bold text-lg text-foreground">{top3[2].name}</div>
            ...
            <tbody>
              {rest.map((user, idx) => (
                ...
                >
                  ...
                  <td className="p-4 text-right text-purple-500 font-medium">{user.codingScore.toLocaleString()}</td>
                  <td className="p-4 text-right text-cyan-500 font-medium">{user.mathScore.toLocaleString()}</td>
                  <td className="p-4 text-right">
                    <div className="flex items-center justify-end gap-1 text-orange-500 font-medium">
                      {user.streak} <Flame className="w-4 h-4" />
                    </div>
                  </td>
                  <td className="p-4 text-right font-bold text-blue-500">{user.totalPoints.toLocaleString()}</td>
                </motion.tr>
              ))}
            </tbody>
          </table>
